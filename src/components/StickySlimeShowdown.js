          ...
          <div style={{backgroundColor:'black', paddingTop: '9vh', color:'white' }}>
              ...
              <div style={{display:'flex', justifyContent:'center', flexWrap:'wrap',alignItems:'middle', gap:'2vh', maxWidth:'90vw', margin:'auto'}}>
                  <div style={{width:'90vw'}}>
                    <h2>Overview</h2>
                      <p>Sticky Slime Showdown is a Unity microgame about a slime that traverses through an evolving world.</p>
                      <h2>Description</h2>
                      <p>In Sticky Slime Showdown, the player gains points and grows in size by eating enemy slimes that are the same size or smaller. If a player collides with an enemy that is larger than them, they lose a life. The objective is to collect as many points as possible without losing all of your lives within the given timeframe.</p>
                      <h2>Technologies</h2>
                      <p>Unity, C#.</p>
                      <h2>Gallery</h2>
                  </div>
                  <div className='slimePicture' style={{borderRadius:'20px',width:'80vw', maxWidth:'467px'}}></div>
                  <div className='slimePicture2' style={{borderRadius:'20px',width:'80vw', maxWidth:'467px'}}></div>
                  <div className='slimePicture3' style={{borderRadius:'20px',width:'80vw', maxWidth:'467px'}}></div>
              </div>
          </div>
    ...
    <div>
        ...
        <div style={{backgroundColor:'black', paddingTop: '9vh', color:'white' }}>
            ...
            <div style={{display:'flex', justifyContent:'space-between',alignItems:'flex-start',maxWidth:'80vw', gap:'2vw',margin:'auto'}}>
                ...
                <div style={{width:'35vw'}} id="carouselExampleIndicators" className="carousel slide" data-bs-ride="true">
                ...
                <div className="carousel-inner" style={{borderRadius:'20px'}}>
                    <div className="carousel-item active">
                      <div className='slimePicture' style={{minWidth:'300px',width:'35vw', maxWidth:'35vw'}}></div>

                    </div>
                    <div className="carousel-item">
                      <div className='slimePicture2' style={{minWidth:'300px',width:'35vw', maxWidth:'35vw'}}></div>

                    </div>
                    <div className="carousel-item">
                      <div className='slimePicture3' style={{minWidth:'300px',width:'35vw', maxWidth:'35vw'}}></div>
...
export default StickySlimeShowdown;
